    ...
    <>
      <style>{`
        ...
        @media (max-width: 520px) {
          .bsod { padding: 24px 20px; font-size: 12px; }
          .bsod-bar-outer { width: 140px; }
        }
      `}</style>
      <div className={`bsod${fading ? " fade" : ""}`}>
        ...
        <p>Press any key to continue <span className="blink">_</span></p>
        <div className="bsod-bar-wrap">
          <span>Loading notfound.exe</span>
